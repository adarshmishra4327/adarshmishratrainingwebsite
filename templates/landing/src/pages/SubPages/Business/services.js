                        ...
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="busi-services-box p-4 bg-white mt-5">
                                    ...
                                    <div className="busi-services-desc">
                                        <h5 className="mb-4 f-18">Digital Design</h5>
                                        <p className="text-muted mb-0">It is a long established fact that a reader will be distracted by the content of a page when looking at its layout.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="busi-services-box  p-4 bg-white mt-5">
                                    ...
                                    <div className="busi-services-desc">
                                        <h5 className="mb-4 f-18">Unlimited Colors</h5>
                            ...
                            <div className="col-lg-4">
                                <div className="busi-services-box p-4 bg-white mt-5">
                                    ...
                                    <div className="busi-services-desc">
                                        <h5 className="mb-4 f-18">Strategy Solutions</h5>
                                        <p className="text-muted mb-0">He lay on his armour-like back, and if he lifted his head a little he could see his brown belly, slightly domed</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="busi-services-box p-4 bg-white mt-5">
                                    ...
                                    <div className="busi-services-desc">
                                        <h5 className="mb-4 f-18">Awesome Support</h5>
                                        <p className="text-muted mb-0">The wonderful serenity has taken of my these sweet mornings of spring which enjoy with my whole heart.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="busi-services-box p-4 bg-white mt-5">
                                    ...
                                    <div className="busi-services-desc">
                                        <h5 className="mb-4 f-18">Truly Multipurpose</h5>
                            ...
                            <div className="col-lg-4">
                                <div className="busi-services-box p-4 bg-white mt-5">
                                    ...
                                    <div className="busi-services-desc">
                                        <h5 className="mb-4 f-18">Easy to customize</h5>
